...
class PeerDownloadTestSuite(unittest.TestCase):
    ...
    def test_get_multiple_files(self):
        path = at.get('b79869ca12787166de88311ca1f28e3ebec12dec', use_timestamp=False)
        files = os.listdir(path)
        self.assertTrue(len(files) == 174)

    def test_redownload_only_one_file(self):
        path = at.get('b79869ca12787166de88311ca1f28e3ebec12dec', use_timestamp=False)  # test torrent
        files = os.listdir(path)
        self.assertTrue(len(files) == 174)
    ...
    def test_get_single_file(self):
        filename = at.get('323a0048d87ca79b68f12a6350a57776b6a3b7fb', use_timestamp=False)
